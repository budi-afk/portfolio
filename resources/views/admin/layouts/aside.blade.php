    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <form action="{{ route('logout') }}" method="POST" class="dropdown-item has-icon d-flex ">
                    @csrf
                    <button type="submit" class="border border-none text-danger"><i class="fas fa-sign-out-alt"></i>
                        Logout</button>
                </form>
